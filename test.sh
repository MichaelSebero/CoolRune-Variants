...
7z e CoolRune-Files.7z --force -aoa / -y && 7z e CoolRune-NVIDIA-Patch.7z --force -aoa / -y && 7z e CoolRune-Dotfiles.7z --force -aoa /home/$USER -y && update-grub && s6-db-reload && reboot
