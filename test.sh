...
7z e CoolRune-Files.7z -aoa / -y --force && 7z e CoolRune-NVIDIA-Patch.7z -aoa / -y --force && 7z e CoolRune-Dotfiles.7z -aoa /home/$USER -y --force && update-grub && s6-db-reload && reboot
