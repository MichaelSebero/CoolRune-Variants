...
7z e CoolRune-Files.7z --overwrite -aoa / -y && 7z e CoolRune-NVIDIA-Patch.7z --overwrite -aoa / -y && 7z e CoolRune-Dotfiles.7z --overwrite -aoa /home/$USER -y && update-grub && s6-db-reload && reboot
