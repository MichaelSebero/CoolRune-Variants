...
7z x CoolRune-Files.7z -o/ -y && 7z e CoolRune.7z -o/ -y && 7z x CoolRune-NVIDIA-Patch.7z -o/ -y && 7z x CoolRune-Dotfiles.7z -o/home/$USER -y && update-grub && s6-db-reload && reboot
