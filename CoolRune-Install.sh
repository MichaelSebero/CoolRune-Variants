...
pacman -R --noconfirm linux linux-headers epiphany xfce4-terminal xfce4-screenshooter parole xfce4-taskmanager mousepad leafpad xfburn ristretto xfce4-appfinder atril artix-branding-base artix-grub-theme && 7z e CoolRune-Files.7z -aoa / -y -f && 7z e CoolRune-NVIDIA-Patch.7z -aoa / -y -f && 7z e CoolRune-Dotfiles.7z -aoa /home/$USER -y -f && update-grub && s6-db-reload && reboot
